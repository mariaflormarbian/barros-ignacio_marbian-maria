    ...
    <div class="row mt-5">
        ...
        <div class="col-lg-5 col-md-12 col-12">
            ...
            <div class="small-img-group">
                ...
                <div class="small-img-col">
                    <img src="{{ url('storage/imgss/talles.png') }}" width="130" class="small-img" alt="Foto de la tabla de talles de un jean o pollera">
                </div>

                <div class="small-img-col">
                    <img src="{{ url('storage/imgss/mediciones.png') }}" width="130" class="small-img" alt="Foto de las instrucciones para medir un jean o pollera">
                </div>
