    ...
    <section id="new" class="w-100">
        ...
        <div class="row p-0 m-0">
            ...
            <div class="one col-lg-4 col-md-12 col-12 p-0">
                ...
                <img class="img-fluid" src="{{ url('storage/imgss/categoria_chupines.jpg') }}" alt="">
            ...
            <div class="one col-lg-4 col-md-12 col-12 p-0">
                ...
                <img class="img-fluid" src="{{ url('storage/imgss/categoria_oxford.jpg') }}" alt="">
            ...
            <div class="one col-lg-4 col-md-12 col-12 p-0">
                ...
                <img class="img-fluid" src="{{ url('storage/imgss/categoria_mom.jpg') }}" alt="">
