...
<div class="col-md-4">
    ...
    @error ('titulo')
    <div class="text-danger fs-6" id="error-titulo"><span class="visually-hidden">Error:</span>{{$message}}
    </div>
    @enderror
</div>
...
<div class="col-md-4">
    ...
    <textarea
        ...
        name="texto"
        class="form-control"
        @error('texto') aria-describedby="error-texto" @enderror>{{ old('texto', $novedad->texto ?? '')}}
</textarea>
