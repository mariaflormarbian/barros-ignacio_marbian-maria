        ...
        <div class="row">
            ...
            <div class="col">
                ...
                <div class="shadow-lg p-3 mb-5 mt-4 bg-body rounded m-auto" id="form-login">
                    ...
                    <form action="{{ route('admin.productos.editar.ejecutar', ['id' => $producto->producto_id]) }}"
                        method="post" class="row g-3 needs-validation" enctype="multipart/form-data" novalidate>

                        @csrf

                        @if ($errors->any())
                        <p class="mb-3 text-danger fs-6">Hay errores de validación en el formulario. Por favor, revisá
                            los datos e intentá nuevamente.</p>
                        @endif
