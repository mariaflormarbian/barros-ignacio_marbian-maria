...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white py-3 fixed-top">
        ...
        <div class="container">
            ...
            <img src="{{ url('storage/imgss/logo.png') }}" width="50" height="50" alt="Logo ieta color negro">
    ...
    <footer class="mt-5 py-5">
        ...
        <div class="row container mx-auto pt-5">
            ...
            <div class="footer-one col-lg-4 col-md-6 col-12">
                ...
                <img src="{{ url('storage/imgss/logo_footer.png') }}"  alt="Logo ieta color blanco">

                <p class="pt-3">Podés visitarnos en nuestro Showroom</p>

                <div class="col-lg-3 col-md-6 col-12 mb-4">
                    <img src="{{ url('storage/imgss/payment.png') }}" alt="">
                </div>
            ...
            <div class="footer-one col-lg-4 col-md-6 col-12 mb-3">
                ...
                <div class="row">
                    ...
                    <img class="img-fluid w-25 h-100 m-2" src="{{ url('storage/imgss/chupin_key.jpg') }}" alt="">
                    <img class="img-fluid w-25 h-100 m-2" src="{{ url('storage/imgss/chupin_aion.jpg') }}" alt="">
                    <img class="img-fluid w-25 h-100 m-2" src="{{ url('storage/imgss/chupin_eros.jpg') }}" alt="">
                    <img class="img-fluid w-25 h-100 m-2" src="{{ url('storage/imgss/chupin_farah.jpg') }}" alt="">
                    <img class="img-fluid w-25 h-100 m-2" src="{{ url('storage/imgss/chupin_satya.jpg') }}" alt="">
